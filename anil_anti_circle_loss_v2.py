...
def main(args):
    ...
    # loss_circle = losses.CircleLoss(m=0.4, gamma=256)
    # loss_circle = losses.CircleLoss(m=0.4, gamma=80)
    # loss_circle = losses.CircleLoss(m=0.1, gamma=80)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_path', type=str, default="output/anil_anti_circle_v2/", metavar='S',
                        help='output dir')
